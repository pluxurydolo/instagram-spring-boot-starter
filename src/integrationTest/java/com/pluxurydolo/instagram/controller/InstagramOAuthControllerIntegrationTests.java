...
class InstagramOAuthControllerIntegrationTests extends AbstractControllerIntegrationTests {
    ...
    private static String locationHeader() {
        return "https://www.facebook.com/v26.0/dialog/oauth?client_id=id&redirect_uri=http://localhost:8888$/app-name/v1/instagram/login/redirect&scope=instagram_basic,instagram_content_publish,business_management&response_type=code";
    }
}
